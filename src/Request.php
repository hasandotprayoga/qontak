...
class Request
{
    ...
    public function __construct()
    {
        ...
        $this->baseUrl = 'https://chat-service.qontak.com';
        $this->username = 'admin@yukbisnis.com';
        $this->password = 'yukbisnis123';
        $this->clientId = 'RRrn6uIxalR_QaHFlcKOqbjHMG63elEdPTair9B9YdY';
        $this->clientSecret = 'Sa8IGIh_HpVK1ZLAF0iFf7jU760osaUNV659pBIZR00';
        $this->channelId = 'e6b8d027-9e89-4ada-b208-84f94a27711a';
    }
